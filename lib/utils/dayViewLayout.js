...
function getStyledEvents(_ref7) {
  ...
  var helperArgs = { events: events, startAccessor: startAccessor, endAccessor: endAccessor, min: min, showMultiDayTimes: showMultiDayTimes, totalMin: totalMin, step: step };
  var styledEvents = [];
  var idx = 0;
